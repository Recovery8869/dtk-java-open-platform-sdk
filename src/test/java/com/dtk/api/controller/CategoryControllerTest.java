...
class CategoryControllerTest {
    ...
    void getHotSearch() {
        ...
        request.setUrl("https://openapi.dataoke.com/api/category/get-top100");
    ...
    void getSuperCategory() {
        ...
        request.setUrl("https://openapi.dataoke.com/api/category/get-super-category");
    ...
    void getDdqGoodsList() {
        ...
        request.setUrl("https://openapi.dataoke.com/api/category/ddq-goods-list");
        request.setVersion("v1.1.0");
